...
app.post('/api/debug-tag-setup', async (req, res) => {
  try {
    const productsToTag = [
      // EFS
      { id: "gid://shopify/Product/10283136712995", tags: ["75-series", "79-series"] },
      { id: "gid://shopify/Product/10285306773795", tags: ["79-series"] },
      { id: "gid://shopify/Product/10283138548003", tags: [] }, // Universal weight scale
      { id: "gid://shopify/Product/10283137204515", tags: ["79-series"] },
      { id: "gid://shopify/Product/10283138973987", tags: [] }, // Universal tow ball
      { id: "gid://shopify/Product/10285309264163", tags: ["79-series"] },
      { id: "gid://shopify/Product/10285308870947", tags: ["79-series"] },
      { id: "gid://shopify/Product/10285304807715", tags: ["79-series"] },
      { id: "gid://shopify/Product/10285313098019", tags: ["75-series"] },
      { id: "gid://shopify/Product/10285310017827", tags: ["79-series"] }, // Steering Damper 79
      { id: "gid://shopify/Product/10285311426851", tags: ["79-series"] }, // Steering Damper Extreme 79
      { id: "gid://shopify/Product/10283137696035", tags: [] }, // Tow ball mount
      { id: "gid://shopify/Product/10283138679075", tags: [] }, // Hitch Pin

      // Westralia Springs
      { id: "gid://shopify/Product/10207088181539", tags: ["78-series", "79-series"] },
      { id: "gid://shopify/Product/10223412904227", tags: ["75-series"] },

      // Fulcrum
      { id: "gid://shopify/Product/10283128750371", tags: ["78-series", "79-series"] },
      { id: "gid://shopify/Product/10283131404579", tags: ["79-series"] },
      { id: "gid://shopify/Product/10283110695203", tags: ["75-series"] },
      { id: "gid://shopify/Product/10283118887203", tags: ["78-series", "79-series"] },
      { id: "gid://shopify/Product/10283122196771", tags: ["78-series", "79-series"] },
      { id: "gid://shopify/Product/10283121574179", tags: ["79-series"] },
      { id: "gid://shopify/Product/10283125670179", tags: ["78-series", "79-series"] },
    ...
    console.log("Applying vehicle series tags to suspension products...");
    let tagCount = 0;
    for (const item of productsToTag) {
      if (item.tags.length > 0) {
        const tagRes = await client.request(tagsAddMutation, {
          variables: {
            id: item.id,
            tags: item.tags
          }
        });
        if (tagRes.data.tagsAdd.userErrors.length > 0) {
          console.error(`❌ Error tagging product ${item.id}:`, tagRes.data.tagsAdd.userErrors);
        } else {
          tagCount++;
        }
    ...
    // 2. Create the 9 Smart Collections using Type + Tag conditions
    const restClient = new shopify.clients.Rest({ session });
    const subCollections = [
      { title: "79 Series EFS", type: "EFS", tag: "79-series" },
      { title: "75 Series EFS", type: "EFS", tag: "75-series" },
      
      { title: "79 Series Westralia Springs", type: "Westralia Springs", tag: "79-series" },
      { title: "78 Series Westralia Springs", type: "Westralia Springs", tag: "78-series" },
      { title: "75 Series Westralia Springs", type: "Westralia Springs", tag: "75-series" },
      
      { title: "79 Series Fulcrum", type: "Fulcrum", tag: "79-series" },
      { title: "78 Series Fulcrum", type: "Fulcrum", tag: "78-series" },
      { title: "75 Series Fulcrum", type: "Fulcrum", tag: "75-series" },
      
      { title: "79 Series Bilstein", type: "Bilstein", tag: "79-series" }
    ];
        ...
        const colRes = await restClient.post({
          ...
          data: {
            smart_collection: {
              ...
              disjunctive: false // Match ALL rules
            }
          }
        });
