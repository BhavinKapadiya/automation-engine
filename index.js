...
app.post('/api/debug-setup-three-collections', async (req, res) => {
  try {
    const productsData = {
      lighting: [
        "gid://shopify/Product/8939637047587",
        "gid://shopify/Product/8939637309731",
        "gid://shopify/Product/9759854264611",
        "gid://shopify/Product/9759838273827",
        "gid://shopify/Product/9765245550883",
        "gid://shopify/Product/9765240897827",
        "gid://shopify/Product/9929537421603",
        "gid://shopify/Product/9787579203875",
        "gid://shopify/Product/9929533391139",
        "gid://shopify/Product/10033193746723",
        "gid://shopify/Product/10033194696995",
        "gid://shopify/Product/10087579353379",
        "gid://shopify/Product/10063735750947",
        "gid://shopify/Product/10223458943267",
        "gid://shopify/Product/10223458844963",
        "gid://shopify/Product/10223453995299",
        "gid://shopify/Product/10223453667619",
        "gid://shopify/Product/10289862246691",
        "gid://shopify/Product/10291799818531",
        "gid://shopify/Product/10292013302051",
        "gid://shopify/Product/10289920672035",
        "gid://shopify/Product/10297281708323"
      ],
      radio: [
        "gid://shopify/Product/10223597781283",
        "gid://shopify/Product/10279139180835",
        "gid://shopify/Product/10279088914723",
        "gid://shopify/Product/10279111524643",
        "gid://shopify/Product/10280135426339",
        "gid://shopify/Product/10280121925923",
        "gid://shopify/Product/10280151875875",
        "gid://shopify/Product/10279114146083",
        "gid://shopify/Product/10280150073635"
      ],
      throttle: [
        "gid://shopify/Product/10280197357859",
        "gid://shopify/Product/10280212300067",
        "gid://shopify/Product/10280205156643"
      ]
    };
    ...
    // Helper function to update a product and its metafields
    async function updateProduct(id, type) {
      // 1. Update product type
      await client.request(productUpdateMutation, {
        variables: { input: { id, productType: type } }
      });
      // 2. Set product department metafield
      ...
      updatedCount++;
      await new Promise(resolve => setTimeout(resolve, 80)); // stay rate limit friendly
    }

    console.log("Updating lighting products...");
    for (const id of productsData.lighting) {
      await updateProduct(id, "12V Lighting");
    }

    console.log("Updating radio products...");
    for (const id of productsData.radio) {
      await updateProduct(id, "UHF Radios");
    }

    console.log("Updating throttle products...");
    for (const id of productsData.throttle) {
      await updateProduct(id, "Throttle Controllers");
    }

    // 3. Create the 3 Smart Collections in Shopify
    const restClient = new shopify.clients.Rest({ session });
    const collectionsToCreate = [
      { title: "12V Lighting", type: "12V Lighting" },
      { title: "UHF Radios", type: "UHF Radios" },
      { title: "Throttle Controllers", type: "Throttle Controllers" }
    ];
    ...
    for (const coll of collectionsToCreate) {
      ...
      createdCollections.push(colRes.body.smart_collection.title);
