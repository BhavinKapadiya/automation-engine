...
app.post('/api/debug-set-bulk-collection-images', async (req, res) => {
  try {
    const groups = [
      {
        fileId: "43221627175203", // 60 Series
        collections: [
          "gid://shopify/Collection/507243495715", // 60 Series Bonnets
          "gid://shopify/Collection/507509506339", // 60 Series Cabins & Supports
          "gid://shopify/Collection/507243462947", // 60 Series Doors
          "gid://shopify/Collection/507441119523", // 60 Series Grilles
          "gid://shopify/Collection/507509801251", // 60 Series Guards & Supports
          "gid://shopify/Collection/507267285283", // 60 Series Guards and Supports
          "gid://shopify/Collection/507243561251", // 60 Series Lighting
          "gid://shopify/Collection/507243528483"  // 60 Series Suspension
        ]
      },
      {
        fileId: "43221512618275", // 70 Series
        collections: [
          "gid://shopify/Collection/507528577315", // 70 Series 12V Lighting
          "gid://shopify/Collection/507534377251", // 70 Series Accessories
          "gid://shopify/Collection/507243659555", // 70 Series Bonnets
          "gid://shopify/Collection/507509539107", // 70 Series Cabins & Supports
          "gid://shopify/Collection/507239104803", // 70 Series Doors
          "gid://shopify/Collection/507509834019", // 70 Series Guards & Supports
          "gid://shopify/Collection/507239203107", // 70 Series Lighting
          "gid://shopify/Collection/507243692323", // 70 Series Suspension
          "gid://shopify/Collection/507441086755"  // 70 Series Tubs
        ]
      },
      {
        fileId: "43221770666275", // 75 Series
        collections: [
          "gid://shopify/Collection/507534410019", // 75 Series Accessories
          "gid://shopify/Collection/507449442595", // 75 Series Bonnets
          "gid://shopify/Collection/507509604643", // 75 Series Cabins & Supports
          "gid://shopify/Collection/507449671971", // 75 Series differentials and lockers
          "gid://shopify/Collection/507531559203", // 75 Series EFS
          "gid://shopify/Collection/507531755811", // 75 Series Fulcrum
          "gid://shopify/Collection/507509899555", // 75 Series Guards & Supports
          "gid://shopify/Collection/507449770275", // 75 Series Suspension
          "gid://shopify/Collection/507532804387", // 75 Series Tail Lights
          "gid://shopify/Collection/507449639203", // 75 Series tub
          "gid://shopify/Collection/507531657507"  // 75 Series Westralia Springs
        ]
      },
      {
        fileId: "43221712503075", // 79 Series
        collections: [
          "gid://shopify/Collection/507528544547", // 79 Series 12V Lighting
          "gid://shopify/Collection/507534344483", // 79 Series Accessories
          "gid://shopify/Collection/507531788579", // 79 Series Bilstein
          "gid://shopify/Collection/507243823395", // 79 Series Bonnets
          "gid://shopify/Collection/507509637411", // 79 Series Cabins & Supports
          "gid://shopify/Collection/507243790627", // 79 Series Doors
          "gid://shopify/Collection/507531526435", // 79 Series EFS
          "gid://shopify/Collection/507531690275", // 79 Series Fulcrum
          "gid://shopify/Collection/507510227235", // 79 Series Grilles
          "gid://shopify/Collection/507509965091", // 79 Series Guards & Supports
          "gid://shopify/Collection/507532673315", // 79 Series Headlights
          "gid://shopify/Collection/507239366947", // 79 Series Lighting
          "gid://shopify/Collection/507243856163", // 79 Series Suspension
          "gid://shopify/Collection/507532706083", // 79 Series Tail Lights
          "gid://shopify/Collection/507453210915", // 79 Series Tubs
          "gid://shopify/Collection/507531591971"  // 79 Series Westralia Springs
        ]
      }
    ];
    ...
    for (const group of groups) {
      ...
      for (const prefix of ["MediaImage", "GenericFile", "File"]) {
        try {
          const nodeRes = await client.request(nodeQuery, { variables: { id: `gid://shopify/${prefix}/${group.fileId}` } });
      ...
      if (!imageUrl) {
        results.push({ fileId: group.fileId, success: false, error: "Could not retrieve image URL" });
        continue;
      }

      console.log(`📸 Found CDN URL for file ${group.fileId}: ${imageUrl}`);

      for (const cid of group.collections) {
        try {
          const response = await client.request(collectionUpdateMutation, {
            variables: { input: { id: cid, image: { src: imageUrl } } }
          });
          const collectionUpdate = response.data.collectionUpdate;
          if (collectionUpdate.userErrors.length > 0) {
            results.push({ id: cid, success: false, fileId: group.fileId, errors: collectionUpdate.userErrors });
          } else {
            results.push({ id: cid, success: true, title: collectionUpdate.collection.title });
          }
        } catch (err) {
          results.push({ id: cid, success: false, fileId: group.fileId, error: err.message });
        }
